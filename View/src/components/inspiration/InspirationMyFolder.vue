...
import { ref } from 'vue'
import type { UserPaperFolder, UserPaper } from '../../types/paper'
import InspirationPaperRow from './InspirationPaperRow.vue'
// Self-reference for recursion — Vue resolves by filename automatically in SFC.
// eslint-disable-next-line @typescript-eslint/no-unused-vars
import InspirationMyFolder from './InspirationMyFolder.vue'
...
function paperTitle(p: UserPaper): string {
