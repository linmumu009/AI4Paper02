...
def _get_config_description(key: str) -> str:
    ...
    descriptions = {
        ...
        "PDF_CLEANUP_PRESSURE_ENABLED": "磁盘剩余空间不足时自动提前清理未收藏公共缓存",
        "PDF_CLEANUP_MIN_FREE_GB": "低空间保护触发阈值（GB）",
        "PDF_CLEANUP_PRESSURE_RETENTION_DAYS": "低空间保护触发时的临时保留天数",
