...
def run(args: argparse.Namespace) -> None:
    ...
    if output_mode == "db":
        ...
        if not preview_dir.is_dir():
            print(
                ...
                "skip (shared phase may have produced 0 papers today)",
                flush=True,
            )
    ...
    if not arxiv_json_path:
        ...
        # DB mode with no matching JSON: meta_map will be empty (unknown metadata).
        # Papers are still processed; title/published will be empty strings.
